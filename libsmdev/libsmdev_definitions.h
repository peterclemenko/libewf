...
#define LIBSMDEV_VERSION				20120715

/* The version string
 */
#define LIBSMDEV_VERSION_STRING				"20120715"
...
#define LIBSMDEV_FLAG_READ				LIBSMDEV_ACCESS_FLAG_READ
#define LIBSMDEV_FLAG_WRITE				LIBSMDEV_ACCESS_FLAG_WRITE
#define LIBSMDEV_FLAG_TRUNCATE				LIBSMDEV_ACCESS_FLAG_TRUNCATE
